$(function() {
    ...
    function init() {
        ...
        $('#btn-export').on('click',function (e){
            ...
            if(stime != '' && etime != ''){
                location.href='/admin/schoolvideo/export-student-videorecord?&stime='+stime+'&etime='+etime;
            }else if(stime == '' && etime == ''){
                location.href='/admin/schoolvideo/export-student-videorecord';
            }else{
        ...
        newObj.tblist = $('#tbList').DataTable({
            ...
            'initComplete': function() {
                ...
                $('#tbList tbody').on('click', 'tr', function(e) {
                    ...
                    window.open('/admin/banwu/videolistview?id='+ data[0],'_blank');
