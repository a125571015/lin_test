$(function() {
    ...
    function init() {
		...
		$('#btn-close').on('click',function(e){
            ...
            dataObj.id = id;
            $.ajax({
                url: '/admin/banner-login/inactive',
        ...
        newObj.tblist = $('#tbList').DataTable({
            ...
            'initComplete': function () {
                ...
                $('#tbList tbody').on('click', 'tr', function(e){
                    ...
                    location.href =  '/admin/banner-login/view_data?id=' + data[0];
            ...
            'drawCallback':function(){
                newObj.tblist.rows().every(function(){
                    ...
                    if (img != '') {
                        item[2] = '<img src="' + img + '?v=' + Math.random() + '" style="width:200px" >';
                    }
