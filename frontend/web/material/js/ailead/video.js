        ...
        newObj.tblist = $('#tbList').DataTable({
            ...
            'initComplete': function () {
                ...
                $('#tbList tbody').on('click', 'tr', function(e){
                    ...
                    location.href =  '/admin/video/view_data?id=' + data[0];
            ...
            'drawCallback':function(){
                newObj.tblist.rows().every(function(){
                    ...
                    if (youtube_id != '') {
                        item[5] = '<iframe width="253" height="159" src="https://www.youtube.com/embed/'+youtube_id+'"></iframe>';
                    }
