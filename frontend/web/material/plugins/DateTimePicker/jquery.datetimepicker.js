		...
		var KEY0 = 48,
			...
			createDateTimePicker = function( input ) {
				...
				var setPos = function () {
				    ...
				    if (location.href.toUpperCase().indexOf('CALENDAR.ASPX') != -1 || location.href.toUpperCase().indexOf('CDETAIL.ASPX') != -1) {
				        top = offset.top + datetimepicker.data('input')[0].offsetHeight - 110;
				    }
